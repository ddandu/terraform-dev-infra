...
#Ensures this block re-runs whenever the MongoDB EC2 instance changes.
#Acts as a provisioner wrapper to run commands on the instance.
...
resource "terraform_data" "mysql" {
  ...
  resource "aws_route53_record" "mongodb" {
    zone_id = var.zone_id
    name    = "mongodb-${var.environment}.${var.domain_name}" # mongodb-dev.devresh.online
    type    = "A"
    ttl     = 1
